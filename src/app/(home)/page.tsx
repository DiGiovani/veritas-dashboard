...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-dvw min-h-dvh">
      ...
      >
        <div
          className="flex px-64 items-center justify-center w-full h-full min-h-[calc(100dvh-96px)]"
          style={{
      ...
      <div id="services" className="flex flex-col items-center justify-center w-full  px-64 py-8 bg-[#09090B]">
      ...
      <div id="about">
        <div className="flex flex-col items-center justify-center w-full px-64 py-8 bg-[#09090B]">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-gray-100 text-sans">
            Sobre nós
          </h2>
          <p className="mt-4 text-lg text-center text-gray-700 dark:text-gray-300 max-w-4xl">
            A Veritas é uma empresa de segurança e serviços, focada em soluções em tecnologia
            para a segurança da informação. Com uma equipe altamente qualificada e comprometida,
            oferecemos serviços personalizados para atender às necessidades de nossos clientes.
            Nossa missão é garantir a proteção e a tranquilidade de nossos clientes, utilizando
            as melhores práticas e tecnologias disponíveis no mercado.
          </p>
        </div>
      </div>
    </div>
